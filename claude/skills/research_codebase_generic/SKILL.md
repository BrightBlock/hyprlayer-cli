...
synthesizing the maps into a research artifact. Generic variant: it assumes nothing
about the project's thoughts directory or which specialist agents it has.
